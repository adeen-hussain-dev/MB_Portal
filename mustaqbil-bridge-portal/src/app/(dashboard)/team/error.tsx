...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="rounded-[2rem] border border-[#D8E0EA] bg-white p-8 shadow-sm">
      <h1 className="font-heading text-2xl font-semibold text-[#101828]">Volunteer directory failed to load</h1>
      <p className="mt-3 text-sm text-[#64748B]">The profiles query did not return successfully.</p>
